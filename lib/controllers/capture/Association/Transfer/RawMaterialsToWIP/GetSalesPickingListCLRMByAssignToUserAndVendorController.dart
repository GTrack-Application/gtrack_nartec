...
class RawMaterialsToWIPController {
  static Future<List<GetSalesPickingListCLRMByAssignToUserAndVendorModel>>
    ...
    print(vendorId);
    final url = Uri.parse(
        '${AppUrls.gtrack}/api/getSalesPickingListCLRMByAssignToUserAndVendor?assign_to_user_id=$userId&vendor_id=$vendorId');
    print(url);
    String? token;
  ...
  static Future<GetMappedBarcodesRMByItemIdAndQtyModel>
    ...
    final url = Uri.parse(
        '${AppUrls.gtrack}getMappedBarcodesRMByItemIdAndQty?item_id=$itemId&qty=$qty');
    print(url);
    final headers = <String, String>{
      'Authorization': token!,
    };
  ...
  static Future<void> insertItemsLnWIP(
    ...
    final url = Uri.parse('${AppUrls.gtrack}insertItemsLnWIP');
    final headers = {
      'Authorization': '$token',
      'Content-Type': 'application/json',
    };
  ...
  static Future<void> insertEPCISEvent(
    ...
    final url = Uri.parse('${AppUrls.gtrack}insertEPCISEvent');
  ...
  static Future<void> insertGtrackEPCISLog(
    ...
    final url = Uri.parse('${AppUrls.gtrack}/api/insertGtrackEPCISLog');
