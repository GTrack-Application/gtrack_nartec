// ignore_for_file: sized_box_for_whitespace, unused_field, avoid_print, depend_on_referenced_packages, unused_local_variable
...
class _RawMaterialsToWIPScreenState extends State<RawMaterialsToWIPScreen> {
  ...
  final TextEditingController _ssccController = TextEditingController();
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarWidget(
          ...
          title: "Raw Materials to WIP".toUpperCase(),
          actions: [
            GestureDetector(
              onTap: () {
                Get.back();
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    child: DropdownSearch<String>(
                      ...
                      selectedItem: "Select Phycical Location",
                    ),
                  ),
                  Container(
              ...
              Container(
                ...
                child: TextFormFieldWidget(
                  ...
                  hintText: "Enter/Scan Bin Number / Rack",
                  width: MediaQuery.of(context).size.width * 0.9,
                  onEditingComplete: () {
              ...
              Container(
                ...
                child: ElevatedButtonWidget(
                  ...
                  onPressed: () {
                    if (dropDownList2.isEmpty || _rackController.text.isEmpty) {
              ...
              Container(
                  margin: const EdgeInsets.only(left: 20),
                  child:
                      TextWidget(text: _site == "By Gtin" ? "GTIN" : "SSCC")),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      margin: const EdgeInsets.only(left: 20),
                      child: TextFormFieldWidget(
                        controller: _site == "By Gtin"
                            ? _gtinController
                            : _ssccController,
                        hintText: _site == "By Sscc"
                            ? "Enter/Scan SSCC No."
                            : "Enter/Scan GTIN No.",
                        width: MediaQuery.of(context).size.width * 0.73,
                        onEditingComplete: () {
  ...
  Future filterMethod() async {
    if (_site == "By Gtin") {
      ...
      if (_gtinController.text.toString().trim().isEmpty) {
        FocusScope.of(context).requestFocus(FocusNode());
      }
      ...
      if (filterTable
          ...
          .toList()
          .contains(_gtinController.text.trim())) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
      ...
      setState(() {
        ...
        for (var data in table) {
          if (data.palletCode.toString().trim() ==
              _gtinController.text.toString().trim()) {
    ...
    if (_site == "By Sscc") {
      ...
      if (_ssccController.text.toString().trim().isEmpty) {
        FocusScope.of(context).requestFocus(FocusNode());
      }
      ...
      if (filterTable
          ...
          .toList()
          .contains(_ssccController.text.trim())) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
      ...
      setState(() {
        ...
        for (var data in table) {
          if (data.itemSerialNo.toString().trim() ==
              _ssccController.text.toString().trim()) {
            filterTable.add(data);
          }
        }
  ...
  void onSearch() async {
    ...
    NewOne.getData(
      ...
      _rackController.text.trim().toString(),
    ).then((value) {
      setState(() {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  margin: const EdgeInsets.only(left: 20),
                  child: TextWidget(
                      text: _site == "By Gtin" ? "Pallet ID" : "Serial No.")),
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
