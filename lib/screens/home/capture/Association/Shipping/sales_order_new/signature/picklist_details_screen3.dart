...
class PicklistDetailsScreen3 extends StatefulWidget {
  ...
  @override
  State<PicklistDetailsScreen3> createState() => _PicklistDetailsScreen3State();
}

class _PicklistDetailsScreen3State extends State<PicklistDetailsScreen3> {
  @override
  void initState() {
    super.initState();
