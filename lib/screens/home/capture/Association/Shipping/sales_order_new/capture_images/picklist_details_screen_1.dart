...
import 'package:gtrack_nartec/screens/home/capture/Association/Shipping/sales_order_new/capture_images/capture_image_screen.dart';

class PicklistDetailsScreen1 extends StatefulWidget {
  const PicklistDetailsScreen1({
    super.key,
  ...
  @override
  State<PicklistDetailsScreen1> createState() => _PicklistDetailsScreen1State();
}

class _PicklistDetailsScreen1State extends State<PicklistDetailsScreen1> {
  @override
  void initState() {
    super.initState();
