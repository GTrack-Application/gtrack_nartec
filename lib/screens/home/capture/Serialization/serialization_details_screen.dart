...
class SerializationDetailsScreen extends StatefulWidget {
  const SerializationDetailsScreen({super.key, required this.employees});

  final GTIN_Model employees;

  @override
  State<SerializationDetailsScreen> createState() =>
      _SerializationDetailsScreenState();
}

class _SerializationDetailsScreenState
    extends State<SerializationDetailsScreen> {
  @override
