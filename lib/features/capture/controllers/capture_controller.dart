...
import 'package:gtrack_nartec/features/identify/models/IDENTIFY/GTIN/gtin_model.dart';
...
class CaptureController {
  ...
  Future<List<SerializationModel>> getSerializationData(gtin) async {
    String url = "/api/getAllRecordsByGTIN?GTIN=$gtin";

    var response = await _httpService.request(url);
